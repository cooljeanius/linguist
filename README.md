...
Sometimes getting the tests running can be to much work especially if you do NOT have much Ruby experience. It is okay, be lazy and let our build bot [Travis](http://travis-ci.org/#!/cooljeanius/linguist) run the tests for you. Just open a pull request and the bot will start cranking away.

Here is this fork's current build status, which is hopefully green: [![Build Status](https://secure.travis-ci.org/cooljeanius/linguist.png?branch=master)](http://travis-ci.org/cooljeanius/linguist)
